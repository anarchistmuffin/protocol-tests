...
export interface BaseRouteControllerInterface extends utils.Interface {
  functions: {
...
export interface BaseRouteController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseRouteControllerInterface;
