...
export interface LabzTokenInterface extends utils.Interface {
  functions: {
    "DOMAIN_SEPARATOR()": FunctionFragment;
    "_decimals()": FunctionFragment;
    "_name()": FunctionFragment;
    "_revision()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "_revision", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "_revision", data: BytesLike): Result;
...
export interface LabzToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LabzTokenInterface;
  ...
  functions: {
    ...
    _revision(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    _revision(overrides?: CallOverrides): Promise<PopulatedTransaction>;
